        ...
        <div data-simplebar class="h-100">
          ...
          <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
              ...
              <li>
                <Link href="first-page" style="color: red">
                  <i data-feather="message-square"></i>
                  <span data-key="t-chat">First Page</span>
                </Link>
              </li>
              <li>
                <Link href="second-page" style="color: red">
                  <i data-feather="message-square"></i>
                  <span data-key="t-chat">Second Page</span>
                </Link>
              </li>
              ...
              <li>
                <a href="javascript: void(0);" class="has-arrow">
                  ...
                  <span data-key="t-email">Test Pages</span>
                </a>
              ...
              <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                  ...
                  <li>
                    <a href="auth-email-verification.html" data-key="t-email-verification"
              ...
              <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                  ...
                  <li>
                    <a href="ui-tabs-accordions.html" data-key="t-tabs-accordions"
                      >Tabs & Accordions</a
                    >
                  </li>
                  <li>
              ...
              <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                  ...
                  <li>
                    <a href="extended-session-timeout.html" data-key="t-session-timeout"
                      >Session Timeout</a
                    >
                  </li>
                  <li><a href="extended-rating.html" data-key="t-rating">Rating</a></li>
                  <li>
                    <a href="extended-notifications.html" data-key="t-notifications"
                      >Notifications</a
                    >
                  </li>
                </ul>
              ...
              <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                  ...
                  <li>
                    <a href="tables-responsive.html" data-key="t-responsive-table"
                      >Responsive</a
                    >
                  </li>
                  <li>
              ...
              <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                  ...
                  <li>
                    <a href="icons-materialdesign.html" data-key="t-material-design"
                      >Material Design</a
                    >
                  </li>
                  <li>
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="text-sm-end d-none d-sm-block">
                  Design & Develop by
                  <a href="#!" class="text-decoration-underline">Tech Check</a>
                </div>
              </div>
            </div>
          </div>
